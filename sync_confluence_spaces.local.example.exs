%{
  ...
  # Plain space keys (e.g. "PED") or overview URLs work as list entries.
  sync_targets: [
    "https://myosotis.atlassian.net/wiki/spaces/PED/overview",
    "https://myosotis.atlassian.net/wiki/spaces/FFP/overview",
    "https://myosotis.atlassian.net/wiki/spaces/myoformfix/overview",
    "https://myosotis.atlassian.net/wiki/spaces/~712020e2d192065fec4c0e90ea115757a438c4/overview?homepageId=3727524416",
    "https://myosotis.atlassian.net/wiki/spaces/MYO/overview"
  ]
}
